<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OrderManagement.aspx.cs" Inherits="MiniProject.OrderManagement" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="rectangle">
            ...
            <asp:Label ID="Label1" runat="server" Text="Order Management" CssClass="label"></asp:Label>
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Double" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False" CssClass="gridView" DataKeyNames="Order_Id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
