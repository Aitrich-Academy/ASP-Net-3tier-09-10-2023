<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="MenuListLunch.aspx.cs" Inherits="MiniProject.MenuListLunch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ProjectConnectionString5.ProviderName %>" SelectCommand="GetDishesByLunch" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
