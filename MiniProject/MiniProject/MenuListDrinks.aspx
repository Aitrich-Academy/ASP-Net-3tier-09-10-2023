<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="MenuListDrinks.aspx.cs" Inherits="MiniProject.MenuListDrinks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ProjectConnectionString5.ProviderName %>" SelectCommand="GetDishesByDrinks" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
