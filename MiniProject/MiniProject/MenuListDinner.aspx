<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="MenuListDinner.aspx.cs" Inherits="MiniProject.MenuListDinner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ProjectConnectionString5.ProviderName %>" SelectCommand="GetDishesByDinner" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
