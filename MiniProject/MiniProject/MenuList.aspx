...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="flex-container">
        <div>
            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="5" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" GridLines="Both" OnItemCommand="DataList1_ItemCommand">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString3 %>" ProviderName="<%$ ConnectionStrings:ProjectConnectionString3.ProviderName %>" SelectCommand="SELECT [Dishe_Name], [Price], [Image], [Status] FROM [Dishes]"></asp:SqlDataSource>
</asp:Content>