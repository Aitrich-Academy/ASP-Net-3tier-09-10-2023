...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="flex-container">
          <div>
              ...
              <asp:ImageButton ID="ImageButton1" runat="server" src="Image/MenuItems/ARROW.png" CssClass="arrow" PostBackUrl="~/MenuList.aspx" />
          ...
          <div>
              ...
              <asp:ImageButton ID="ImageButton2" runat="server" src="Image/MenuItems/ARROW.png" CssClass="arrow" PostBackUrl="~/MenuList.aspx"/>
          ...
          <div>
              ...
              <asp:ImageButton ID="ImageButton3" runat="server" src="Image/MenuItems/ARROW.png" CssClass="arrow" PostBackUrl="~/MenuList.aspx"/>
          ...
          <div>
              ...
              <asp:ImageButton ID="ImageButton4" runat="server" src="Image/MenuItems/ARROW.png" CssClass="arrow" PostBackUrl="~/MenuList.aspx"/>
          ...
          <div>
              ...
              <asp:ImageButton ID="ImageButton5" runat="server" src="Image/MenuItems/ARROW.png" CssClass="arrow" PostBackUrl="~/MenuList.aspx"/>
