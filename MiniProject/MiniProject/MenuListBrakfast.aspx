<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="MenuListBrakfast.aspx.cs" Inherits="MiniProject.MenuListBrakfast" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString5 %>" ProviderName="<%$ ConnectionStrings:ProjectConnectionString5.ProviderName %>" SelectCommand="GetDishesByBrakfast" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</asp:Content>
